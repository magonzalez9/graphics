...
Camera.prototype.tumble = function (rx, ry) {
    ...
    var matA = mult(translate(tumblePoint[0],tumblePoint[1],tumblePoint[2],1), mult(ry, translate(-tumblePoint[0],-tumblePoint[1],-tumblePoint[2],1)));
    var matB = mult(translate(pPrime[0], pPrime[1], pPrime[2], 1), mult(rx, translate(-pPrime[0], - pPrime[1], -pPrime[2],1)));
